...
export default function App() {
  ...
  const setTrace = <K extends keyof VectorOptions['trace']>(key: K, value: VectorOptions['trace'][K]): void => setVectorOptions((o) => ({ ...o, trace: { ...o.trace, [key]: value } }));
